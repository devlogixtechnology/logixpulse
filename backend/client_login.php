...
<head>
    ...
    <title>Client Sign In - LogixPulse</title>
    <style>
...
<div class="container">
    <div class="card">
        ...
        <p class="subtitle">Access your project milestones and invoices</p>
        ...
        <form action="process_client_login.php" method="POST" autocomplete="on">
            ...
            <input id="email" name="email" type="email" required autocomplete="username" placeholder="client1@acmecorp.com">
        ...
        <p class="switch">Internal Staff? <a href="internal_login.php">Go to Internal Login</a></p>
    </div>
</div>
</body>
</html>
