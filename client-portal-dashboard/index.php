 ...
 * Task: FEB-W7D2-2 - Build the Timeline Look
 * Task: FEB-W7D2-3 - Build the Invoice Table Look
 * Task: FEB-W7D3-1 - Connect the Timeline to Real Data
 */
session_start();
require_once __DIR__ . '/includes/timeline.php';

// Client identity comes ONLY from the session (set at login), per the
// FEB-W7D3-1 requirement: "pulled from the database for the logged-in
// client". The real login flow (separate auth task) will populate
// $_SESSION['client_id'] once wired up. Until then, use
// auth/dev-session.php to simulate a login for local testing/demo —
// it is env-gated and refuses to run outside dev (see that file).
$clientId = $_SESSION['client_id'] ?? null;

$timeline = $clientId ? getClientTimeline($clientId) : null;

// --- Sample/dummy data for cards not yet wired to a real backend ---
// These follow the same pattern as the $invoices sample data below:
// static for now, clearly labeled, to be replaced once each service
// (projects, documents, notifications, support) is connected.
$projects = [
...
$notifications = [
    ["message" => "Your invoice INV-2026-023 is due in 4 days.",                    "time" => "2 hours ago", "unread" => true],
    ["message" => "New document \"Brand Guidelines.pdf\" was shared with you.",     "time" => "1 day ago",   "unread" => true],
    ["message" => "Development phase started for LogixPulse Client Portal.",        "time" => "3 days ago",  "unread" => false],
];

$supportTickets = [
    ["id" => "TCK-1042", "subject" => "Question about invoice INV-2026-021", "status" => "Open",     "status_class" => "status-pending", "updated" => "Sep 10, 2026"],
                        ...
                        <div class="simple-list">
                            ...
                            <div class="simple-list-item">
                                <div class="simple-list-body">
                                    ...
                                    <span class="simple-list-meta"><?php echo $project["progress"]; ?>% complete</span>
        ...
        <section id="projects" class="app-section" data-section="projects">
            ...
            <div class="row g-4">
                <article class="col-12">
                    <div class="dashboard-card">
                        <div class="card-header">
                            <h2>All Projects <span class="dummy-data-flag">Sample</span></h2>
                            <span class="card-icon-chip chip-indigo" aria-hidden="true">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
                            </span>
                        </div>
        ...
        <section id="documents" class="app-section" data-section="documents">
            ...
            <div class="row g-4">
                <article class="col-12">
                    <div class="dashboard-card">
                        <div class="card-header">
                            <h2>All Documents <span class="dummy-data-flag">Sample</span></h2>
                            <span class="card-icon-chip chip-blue" aria-hidden="true">
                                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="8" y1="13" x2="16" y2="13"></line><line x1="8" y1="17" x2="16" y2="17"></line></svg>
                            </span>
                        </div>
